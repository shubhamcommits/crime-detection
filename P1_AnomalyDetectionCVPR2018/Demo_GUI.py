...
def load_model(json_path):
    # with open('/Users/shubhamsingh/projects/crime-detection/model.json', 'r') as f:
...
class PrettyWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        Model_dir = '/Users/shubhamsingh/projects/crime-detection/'
        weights_path = Model_dir + 'weights_L1L2.mat'
        model_path = '/Users/shubhamsingh/projects/crime-detection/model.json'
        ########################################
    ...
    def SingleBrowse(self):
        video_path = QtGui.QFileDialog.getOpenFileName(self,
                                                        'Single File',
                                                        "/Users/shubhamsingh/projects/crime-detection/SampleVideos")
